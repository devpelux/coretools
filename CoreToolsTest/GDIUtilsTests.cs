...
namespace CoreToolsTest
{
    ...
    public class GDIUtilsTests
    {
        ...
        public void GetPixelColorAtCursorPosR()
        {
            ...
            Debug.WriteLine(pos);
            Color color = CoreTools.GDIUtils.GetPixelColorAtCursorPos();
        ...
        public void GetPixelColorAtCursorPosR2()
        {
            Point pos = CoreTools.GraphicUtils.GetCursorPos();
            Debug.WriteLine(pos);
            Color color = CoreTools.GDIUtils.GetPixelColorAtCursorPos(true);
            Color testColor = Color.FromArgb(255, 0, 0); //FFFF0000
            Debug.WriteLine("Color getted: " + color);
            Debug.WriteLine("Test color: " + testColor);
            Assert.AreEqual(testColor, color);
        ...
        {
            Bitmap bitmap = CoreTools.GDIUtils.CaptureScreenshotAtCursorPos(new Size(2, 8));
        ...
        {
            Bitmap bitmap = CoreTools.GDIUtils.CaptureScreenshotAtCursorPos(new Size(2, 8), new Size(10, 0));
            for (int i = 0; i < bitmap.Width; i++)
            {
                for (int j = 0; j < bitmap.Height; j++)
                {
